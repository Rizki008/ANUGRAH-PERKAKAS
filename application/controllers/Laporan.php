...
class Laporan extends CI_Controller
{
    ...
    public function index()
    {
        $data = array(
            'title' => 'Laporan',
            'isi' => 'layout/admin/laporan/v_laporan'
        );
    ...
    public function lap_harian()
    {
        ...
        $data = array(
            ...
            'isi' => 'layout/admin/laporan/v_lap_harian'
        );
        $this->load->view('layout/admin/v_wrapper', $data, FALSE);
    }
    ...
    public function lap_bulanan()
    {
        ...
        $data = array(
            ...
            'isi' => 'layout/admin/laporan/v_lap_bulanan'
        );
        $this->load->view('layout/admin/v_wrapper', $data, FALSE);
    }
    ...
    public function lap_tahunan()
    {
        ...
        $data = array(
            ...
            'isi' => 'layout/admin/laporan/v_lap_tahunan'
        );
        $this->load->view('layout/admin/v_wrapper', $data, FALSE);
    }
    ...
    public function lap_stock()
    {
        ...
        $data = array(
            ...
            'tahun' => $tahun,
            'laporan' => $this->m_laporan->lap_harian($tanggal, $bulan, $tahun),
            'isi' => 'layout/admin/laporan/v_lap_stock'
        );
        $this->load->view('layout/admin/v_wrapper', $data, FALSE);
    }
}
