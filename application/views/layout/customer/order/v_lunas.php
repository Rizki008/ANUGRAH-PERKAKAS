    ...
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-200px">
            ...
            <div class="pd-20 card-box height-100-p mb-30">
                ...
                <?php echo form_open_multipart('customer/bayar/' . $pesanan->id_pesanan) ?>
                <div class="row">
                    <div class="col-md-6 col-sm-12">
                    ...
                    <div class="col-md-6 col-sm-12">
                        <div class="form-group">
                            ...
                            <a href="<?= base_url('customer/pesan') ?>" class="btn btn-primary" type="submit"><i class="icon-copy fa fa-angle-double-left"></i></a>
                        </div>
                    </div>
                </div>
                <?php echo form_close() ?>
