...
<head>
    ...
    <!-- switchery css -->
    <link rel="stylesheet" type="text/css" href="<?= base_url() ?>deskapp-master/src/plugins/switchery/switchery.min.css">
    <!-- bootstrap-tagsinput css -->
    <link rel="stylesheet" type="text/css" href="<?= base_url() ?>deskapp-master/src/plugins/bootstrap-tagsinput/bootstrap-tagsinput.css">
    <!-- bootstrap-touchspin css -->
    <link rel="stylesheet" type="text/css" href="<?= base_url() ?>deskapp-master/src/plugins/bootstrap-touchspin/jquery.bootstrap-touchspin.css">
