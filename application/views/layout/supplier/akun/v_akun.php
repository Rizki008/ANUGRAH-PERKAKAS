<div class="main-container">
    <div class="pd-ltr-20 xs-pd-20-10">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 mb-30">
                        <div class="pd-20 card-box height-100-p">
                            <div class="profile-photo">
                                ...
                                <a href="#" class="edit-avatar" data-toggle="modal" data-target="#update-modal<?= $value->id_supplier ?>" type="button"><i class="fa fa-pencil"></i></a>
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane fade height-100-p" id="setting" role="tabpanel">
                                            <div class="profile-setting">
                                                <?php
                                                echo form_open_multipart('supplier/update/' . $value->id_supplier) ?>
        ...
        <?php foreach ($akun_supplier as $key => $value) { ?>
            ...
            <div class="modal fade" id="update-modal<?= $value->id_supplier ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <?php
                            echo form_open_multipart('supplier/edit_gambar/' . $value->id_supplier) ?>
                            <div class="row">
                                <div class="col-lg-12">
