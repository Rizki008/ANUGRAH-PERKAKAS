<div class="main-container">
    <div class="pd-ltr-20 xs-pd-20-10">
                            ...
                            <tr>
                                ...
                                <td><?php
                                    if ($value->status_bayar == 0) { ?>
                                        ...
                                        <button class="btn btn-sm btn-success btn-flat" data-toggle="modal" data-target="#update-modal<?= $value->id_pesanan ?>">Batalkan</button>
                                        <a href=" <?= base_url('admin/proses/' . $value->id_pesanan) ?>" class="btn btn-sm btn-flat btn-primary">Konfirmasi</a>
                                    <?php } else { ?>
                            ...
                            <tr>
                                ...
                                <td><?php
                                    if ($value->status_pesan == 2) { ?>
                                        ...
                                        <button class="btn btn-sm btn-success btn-flat" data-toggle="modal" data-target="#updatebayar-modal<?= $value->id_pesanan ?>">Batalkan</button>
                                        <a href=" <?= base_url('admin/proses_bayar/' . $value->id_pesanan) ?>" class="btn btn-sm btn-flat btn-primary">Konfirmasi</a>
                                    <?php } ?>
                                </td>
                            </tr>
                        <?php } ?>
        ...
        <?php } ?>
        <?php foreach ($pesanan as $key => $value) { ?>
            <div class="modal fade" id="updatebayar-modal<?= $value->id_pesanan ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="myLargeModalLabel">Batalkan Pesanan</h4>
