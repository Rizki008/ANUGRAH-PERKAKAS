            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 col-lg-5">
                    <div class="login-box bg-white box-shadow border-radius-10">
                        ...
                        echo form_open('auth/register_supplier') ?>

                        <div class="input-group custom">
                            <input type="text" name="nama" value="<?= set_value('nama') ?>" class="form-control form-control-lg" placeholder="Nama Lengkap">
                            <div class="input-group-append custom">
                                <span class="input-group-text"><i class="icon-copy dw dw-user1"></i></span>
                            </div>
                        </div>
                        <div class="input-group custom">
                            <input type="text" name="no_tlpn" value="<?= set_value('no_tlpn') ?>" class="form-control form-control-lg" placeholder="No Telpon">
                            <div class="input-group-append custom">
                                <span class="input-group-text"><i class="icon-copy dw dw-user1"></i></span>
                            </div>
                        </div>
                        ...
                        <div class="input-group custom">
                            <input type="password" name="ulangi_password" value="<?= set_value('ulangi_password') ?>" class="form-control form-control-lg" placeholder="**********">
                            <div class="input-group-append custom">
                                <span class="input-group-text"><i class="dw dw-padlock1"></i></span>
                            </div>
                        </div>
                        <div class="input-group custom">
                            <input type="text" name="alamat" value="<?= set_value('alamat') ?>" class="form-control form-control-lg" placeholder="Alamat">
                            <div class="input-group-append custom">
                                <span class="input-group-text"><i class="icon-copy dw dw-user1"></i></span>
                            </div>
                        </div>
                        <!-- <div class="input-group custom">
                            <select class="form-control selectpicker" name="status" title="Select Status">
                                <option name="status" value="supplier">Supplier</option>
                                <option name="status" value="customer">Customer</option>
                            </select>
                            <div class="input-group-append custom">
                                <span class="input-group-text"><i class="icon-copy dw dw-user1"></i></span>
                            </div>
                            ...
                            <div class="col-sm-12">
                                <div class="input-group mb-0">
                                    <!--
										...
										-->
                                    <button type="submit" class="btn btn-primary btn-lg btn-block">Register To Create Account</button>
                                </div>
                                <div class="font-16 weight-600 pt-10 pb-10 text-center" data-color="#707373">OR</div>
                                <div class="input-group mb-0">
                                    <a class="btn btn-outline-primary btn-lg btn-block" href="<?= base_url('auth/login_supplier') ?>">Sign In</a>
                                </div>
                            </div>
                        </div>
                        <?php echo form_close() ?>
